# [Milestone 22] [Jules: Gemini 3.1 Pro] Achievement & Save System
...
- 현재 모듈: Assets/Scripts/Meta/
- 관련 배경: 업적 달성 및 세이브/로드 시스템 구축
- 연관 시스템: PlayerPrefs, JSON Serialization
</context>
...
<task>
1. `../../SUMMARY.xml` 확인.
2. [Task: Achievement & Save System Implementation]
   - `AchievementManager.cs`: 조건부 업적 달성 및 알림 이벤트 발행.
   - `SaveSystem.cs`: JSON 기반 데이터 저장 및 로드 로직.
