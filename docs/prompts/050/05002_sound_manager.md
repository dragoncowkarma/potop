# [Milestone 19] [Jules: Gemini 3.1 Pro] Global Sound Manager
...
- 현재 모듈: Assets/Scripts/Audio/
- 관련 배경: 전역 사운드 매니저 구현
- 연관 시스템: AudioMixer, AudioSource Pooling
</context>
...
<task>
1. `../../SUMMARY.xml` 확인.
2. [Task: Global Sound Manager Implementation]
   - `AudioManager.cs`: SFX/BGM 중앙 관리 허브 구현.
   - 피치 랜덤화 및 오디오 소스 풀링 적용.
   - `PlaySFX`, `PlayBGM` 메서드 구현.
   - 연동: 무기 발사 및 적 사망 시 사운드 출력.
