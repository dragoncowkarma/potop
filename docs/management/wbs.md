...
This document decomposes the **potop** project into manageable work packages, defining scope, assignments, dependencies, and timelines for both human developers and AI agents.
...
|---|---|---|---|
| 0.1.0 | 2026-05-20 | Harness Protocol | Initial WBS draft |
