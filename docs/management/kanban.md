...
|---|---|---|---|---|---|
| {TASK-XXX} | {Description} | {P0} | {Agent/Dev} | {S/M/L/XL} | 2026-05-20 |

### In Progress (WIP: 0 / 3)

| Task ID | Title | Agent/Dev | Phase | Cycle Log | Started | Elapsed |
|---|---|---|---|---|---|---|
| {TASK-XXX} | {Description} | {antigravity/jules/dev} | {RED/GREEN/DOC} | [Log](docs/cycle_logs/{task_id}_log.md) | 2026-05-20 | {Nh} |

### Review (WIP: 0 / 3)

| Task ID | Title | Reviewer | Coverage | Harness Status | PR Link | Review Started |
|---|---|---|---|---|---|---|
| {TASK-XXX} | {Description} | {Reviewer} | {85%} | Verified | {PR link} | 2026-05-20 |

### Done (This Sprint/Period)

| Task ID | Title | Completed | Cycle Time | Retries | Coverage |
|---|---|---|---|---|---|
| {TASK-XXX} | {Description} | 2026-05-20 | {Nd Nh} | {N} | {N%} |

### Blocked

| Task ID | Title | Blocked Since | Blocker Type | Blocker Description | Escalated? |
|---|---|---|---|---|---|
| {TASK-XXX} | {Description} | 2026-05-20 | {Dependency / External / Technical / Decision} | {What is blocking} | {Yes/No} |
...
|---|---|---|---|---|---|---|
| 2026-05-20 | {N} | {N} | {N} | {N} | {N} | {N} |

### Bottleneck Analysis

| Date | Column | WIP at Limit? | Duration | Root Cause | Action Taken |
|---|---|---|---|---|---|
| 2026-05-20 | {In Progress} | {Yes} | {8h} | {Agent retry loop} | {Manual intervention} |
