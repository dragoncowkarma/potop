...
This document describes the software design and architecture of **potop**, translating requirements from the [SRS](../specs/SRS.md) into implementable components, interfaces, and data structures.
